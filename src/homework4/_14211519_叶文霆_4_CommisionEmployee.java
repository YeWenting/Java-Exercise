 ...
 */
public class _14211519_叶文霆_4_CommisionEmployee extends _14211519_叶文霆_4_Employee
{
    private int grossSales;
    private double commissionRate;

    public _14211519_叶文霆_4_CommisionEmployee() { grossSales = 0; commissionRate = 0.0; }
    public _14211519_叶文霆_4_CommisionEmployee(String fn, String ln, String ssn, int gs, double cr)
    {
        super(fn, ln, ssn);
        grossSales = gs;
        commissionRate = cr;
    ...
    public int getEarning() { return (int)(grossSales * commissionRate); }
