 ...
 */
public class _14211519_叶文霆_5_BasePlusCommisionEmployee extends _14211519_叶文霆_5_CommisionEmployee
{
    private int baseSalary;
    
    public _14211519_叶文霆_5_BasePlusCommisionEmployee() { baseSalary = 0; }
    public _14211519_叶文霆_5_BasePlusCommisionEmployee(String fn, String ln, String ssn, int gs, double cr, int bs)
    {
