 ...
 */
public class _14211519_叶文霆_5_CommisionEmployee extends _14211519_叶文霆_5_Employee
{
    private int grossSales;
    private double commissionRate;

    public _14211519_叶文霆_5_CommisionEmployee() { grossSales = 0; commissionRate = 0.0; }
    public _14211519_叶文霆_5_CommisionEmployee(String fn, String ln, String ssn, int gs, double cr)
    {
        super(fn, ln, ssn);
        grossSales = gs;
        commissionRate = cr;
